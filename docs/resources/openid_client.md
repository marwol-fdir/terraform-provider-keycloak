...
is set to `true`.
- `web_origins` - (Optional) A list of allowed CORS origins. To permit all origins of Valid Redirect URIs, add '+'. This does not include the '\*' wildcard though. To permit all origins, explicitly add '\*'."
